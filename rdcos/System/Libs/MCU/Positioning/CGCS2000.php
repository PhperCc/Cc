...
class CGCS2000
{
	...
	function __construct($params)
	{
		...
		$this->datum2000 = Datum::getCGCS2000();
		$this->datum2000->setL0($this->l0);
	}
	...
	public function getXY($gnss)
	{
		...
		$p_BLH = CoordTrans::XYZ2BLH($p_XYZ2, $this->datum2000);
		$po =  CoordTrans::BL2xy($p_BLH, $this->datum2000, 0, 500000, $this->h0);
