var Draw = (function () {
    ...
    Draw.prototype.resetDrawCanvas = function () {
        ...
        this.drawRule();
        this.drawCenter();
        this.log(this.centerGps.lon + ',' + this.centerGps.lat);
    ...
    Draw.prototype.drawCar = function (isMove, ms) {
        ...
        var _loop_1 = function (car) {
            ...
            el.find('img').css({ transform: 'rotate(' + car.deg + 'deg)' });
            if (car.info != '') {
                var d = car.deg * Math.PI / 180.0;
    ...
    Draw.prototype.drawCarGpsPath = function (isOnlyPaver) {
        ...
        for (var _i = 0, _a = GpsDrawData.carGpsList; _i < _a.length; _i++) {
            ...
            var color = isOnlyPaver ? GpsDrawData.paverColor : car['color'];
            car['gpsPoint'] = this.drawGpsRect(this.canvasMain, car, carGps, color, 0.3, 1, 'gray');
            car['lastId'] = carGps.id;
        }
    };
    Draw.prototype.drawCarGpsData = function () {
        ...
        for (var _i = 0, _a = GpsDrawData.carGpsList; _i < _a.length; _i++) {
            ...
            car['gpsPoint'] = this.drawGpsRect(this.canvasMain, car, carGps, color, 1, 1, 'gray');
            car['lastId'] = carGps.id;
        }
    };
    ...
    Draw.prototype.drawCarGpsTimes = function () {
        var carList = this.getCarList();
        if (GpsDrawData.dataShowPaver) {
            this.drawCarGpsPath(true);
        }
